...
public final class SubCell {
	...
	public int distanceToCentral() {
		int absoluteX = Math.abs(this.x()
				- SubCell.centralSubCellOf(this.containingCell()).x());
		int absoluteY = Math.abs(this.y()
				- SubCell.centralSubCellOf(this.containingCell()).y());
